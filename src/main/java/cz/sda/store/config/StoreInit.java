...
//        applicationContext.register(StoreConfig.class, StorePropertiesConfig.class, StoreOpenUi.class, StoreFlywayConfig.class);
        applicationContext.register(StoreConfig.class);
